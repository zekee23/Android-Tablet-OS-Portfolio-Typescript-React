    ...
    <div className="grid grid-cols-3 gap-4 p-4">
      {apps.map((app) => (
        <button
          ...
          className={`${app.id === 'notes' ? 'md:hidden' : ''} flex flex-col items-center p-4 rounded-2xl bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-200 hover:scale-105`}
        >
